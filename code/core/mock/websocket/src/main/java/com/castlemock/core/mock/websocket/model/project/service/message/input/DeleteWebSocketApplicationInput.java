 ...
 * @since 1.5
 */
public class DeleteWebSocketApplicationInput implements Input{
    ...
    public DeleteWebSocketApplicationInput(String webSocketProjectId, String webSocketApplicationId) {
