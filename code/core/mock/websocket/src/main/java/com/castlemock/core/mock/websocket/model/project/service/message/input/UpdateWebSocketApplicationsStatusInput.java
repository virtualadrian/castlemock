 ...
 * @since 1.5
 */
public class UpdateWebSocketApplicationsStatusInput implements Input {
    ...
    public UpdateWebSocketApplicationsStatusInput(String webSocketProjectId, String webSocketApplicationId, WebSocketResourceStatus webSocketResourceStatus) {
    ...
    public WebSocketResourceStatus getWebSocketResourceStatus() {
        return webSocketResourceStatus;
    }

    public void setWebSocketResourceStatus(WebSocketResourceStatus webSocketResourceStatus) {
        this.webSocketResourceStatus = webSocketResourceStatus;
    }
}
