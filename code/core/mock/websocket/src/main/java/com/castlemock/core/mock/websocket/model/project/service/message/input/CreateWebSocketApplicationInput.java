 ...
 * @since 1.5
 */
public class CreateWebSocketApplicationInput implements Input {
    ...
    public CreateWebSocketApplicationInput(String webSocketProjectId, WebSocketApplicationDto webSocketApplication) {
