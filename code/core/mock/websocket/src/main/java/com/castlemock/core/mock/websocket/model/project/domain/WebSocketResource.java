 ...
 */
@XmlRootElement
public class WebSocketResource implements Saveable<String> {

    private String id;
    private String name;
    private String uri;
    private List<WebSocketMockResponse> mockResponses;
    ...
    public List<WebSocketMockResponse> getMockResponses() {
        return mockResponses;
    }

    public void setMockResponses(List<WebSocketMockResponse> mockResponses) {
