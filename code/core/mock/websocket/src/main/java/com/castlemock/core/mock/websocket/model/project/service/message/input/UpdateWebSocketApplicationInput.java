 ...
 * @since 1.5
 */
public class UpdateWebSocketApplicationInput implements Input {
    ...
    public UpdateWebSocketApplicationInput(String webSocketProjectId, String webSocketApplicationId, WebSocketApplicationDto webSocketApplication) {
