 ...
 * @since 1.6
 */
public class ReadWebSocketBroadcasterInput implements Input {
    ...
    public ReadWebSocketBroadcasterInput(String webSocketProjectId, String webSocketTopicId, String webSocketBroadcasterId) {
