...
public class WebSocketResourceDto {
    ...
    private List<WebSocketMockResponseDto> mockResponses = new LinkedList<WebSocketMockResponseDto>();
    ...
    public List<WebSocketMockResponseDto> getMockResponses() {
        return mockResponses;
    }

    public void setMockResponses(List<WebSocketMockResponseDto> mockResponses) {
