 ...
 * @since 1.5
 */
public class DeleteWebSocketTopicsInput implements Input{
    ...
    public DeleteWebSocketTopicsInput(String webSocketProjectId, List<WebSocketTopicDto> webSocketTopics) {
