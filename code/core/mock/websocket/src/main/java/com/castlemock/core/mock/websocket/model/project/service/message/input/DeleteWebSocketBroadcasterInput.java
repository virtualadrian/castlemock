 ...
 * @since 1.6
 */
public class DeleteWebSocketBroadcasterInput implements Input{
    ...
    public DeleteWebSocketBroadcasterInput(String webSocketProjectId, String webSocketTopicId, String webSocketBroadcasterId) {
