 ...
 * @since 1.5
 */
public class UpdateWebSocketTopicsStatusInput implements Input {
    ...
    public UpdateWebSocketTopicsStatusInput(String webSocketProjectId, String webSocketTopicId, WebSocketResourceStatus webSocketResourceStatus) {
