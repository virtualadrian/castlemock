 ...
 * @since 1.5
 */
public class ReadWebSocketApplicationInput implements Input {
    ...
    public ReadWebSocketApplicationInput(String webSocketProjectId, String webSocketApplicationId) {
