 ...
 * @since 1.5
 */
public class UpdateWebSocketTopicInput implements Input {
    ...
    public UpdateWebSocketTopicInput(String webSocketProjectId, String webSocketTopicId, WebSocketTopicDto webSocketTopic) {
