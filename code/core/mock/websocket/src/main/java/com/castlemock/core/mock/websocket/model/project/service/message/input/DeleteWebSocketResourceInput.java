 ...
 * @since 1.5
 */
public class DeleteWebSocketResourceInput implements Input{
    ...
    public DeleteWebSocketResourceInput(String webSocketProjectId, String webSocketApplicationId, String webSocketResourceId) {
