 ...
 * @since 1.5
 */
public class DeleteWebSocketStompApplicationInput implements Input{
    ...
    public DeleteWebSocketStompApplicationInput(String webSocketStompProjectId, String webSocketStompApplicationId) {
