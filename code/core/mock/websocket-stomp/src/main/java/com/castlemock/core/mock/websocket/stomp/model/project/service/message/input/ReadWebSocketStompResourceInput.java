 ...
 * @since 1.5
 */
public class ReadWebSocketStompResourceInput implements Input {
    ...
    public ReadWebSocketStompResourceInput(String webSocketStompProjectId, String webSocketStompApplicationId, String webSocketStompResourceId) {
