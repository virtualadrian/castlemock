 ...
 * @since 1.5
 */
public class ReadWebSocketStompResourceOutput implements Output{

    @NotNull
    private WebSocketStompResourceDto webSocketStompResource;

    public ReadWebSocketStompResourceOutput(WebSocketStompResourceDto webSocketStompResource) {
