 ...
 * @since 1.5
 */
public class DeleteWebSocketStompResourceInput implements Input{
    ...
    public DeleteWebSocketStompResourceInput(String webSocketStompProjectId, String webSocketStompApplicationId, String webSocketStompResourceId) {
