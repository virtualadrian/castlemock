...
package com.castlemock.web.mock.websocket.model.project.service.adapter;
...
import com.castlemock.core.mock.websocket.model.project.service.message.output.*;
...
/**
 * The WebSocket project service adapter is responsible for providing the basic functionality for all the
 * project services.
 ...
 */
@Service
public class WebSocketProjectServiceAdapter implements ProjectServiceAdapter<WebSocketProjectDto> {

    @Autowired
    private ServiceProcessor serviceProcessor;
    private static final WebSocketTypeIdentifier WEBSOCKET_TYPE_IDENTIFIER = new WebSocketTypeIdentifier();
     ...
     */
    @Override
    public WebSocketProjectDto create(WebSocketProjectDto dto) {
        final CreateWebSocketProjectOutput output = serviceProcessor.process(new CreateWebSocketProjectInput(dto));
        return output.getWebSocketProject();
    }
    ...
    public void delete(String id) {
        serviceProcessor.process(new DeleteWebSocketProjectInput(id));
    }
     ...
     */
    @Override
    public WebSocketProjectDto update(String id, WebSocketProjectDto dto) {
        final UpdateWebSocketProjectOutput output = serviceProcessor.process(new UpdateWebSocketProjectInput(id, dto));
        return output.getUpdatedWebSocketProject();
    }
     ...
     */
    @Override
    public List<WebSocketProjectDto> readAll() {
        final ReadAllWebSocketProjectsOutput output = serviceProcessor.process(new ReadAllWebSocketProjectsInput());
        return output.getWebSocketProjects();
    }
     ...
     */
    @Override
    public WebSocketProjectDto read(String id) {
        final ReadWebSocketProjectOutput output = serviceProcessor.process(new ReadWebSocketProjectInput(id));
        return output.getWebSocketProject();
    }
    ...
    public TypeIdentifier getTypeIdentifier() {
        return WEBSOCKET_TYPE_IDENTIFIER;
    }
     ...
     */
    @Override
    public WebSocketProjectDto convertType(ProjectDto parent) {
        return new WebSocketProjectDto(parent);
    }
    ...
    public String exportProject(String id) {
        final ExportWebSocketProjectOutput output = serviceProcessor.process(new ExportWebSocketProjectInput(id));
    ...
    public void importProject(String projectRaw) {
        serviceProcessor.process(new ImportWebSocketProjectInput(projectRaw));
    }
    ...
    public List<SearchResult> search(SearchQuery searchQuery) {
        final SearchWebSocketProjectOutput output = serviceProcessor.process(new SearchWebSocketProjectInput(searchQuery));
