...
<form:form action="${update_webSocket_resource_url}" method="POST" commandName="webSocketResource">
    <table class="formTable">
        <tr>
            <td class="column1"><label path="name"><spring:message code="websocket.updateresource.label.name"/></label></td>
            <td class="column2"><form:input path="name" id="webSocketResourceNameInput" value="${webSocketResource.name}"/></td>
        </tr>
        <tr>
            <td class="column1"><label path="name"><spring:message code="websocket.updateresource.label.uri"/></label></td>
            <td class="column2"><form:input path="uri" id="webSocketResourceUriInput" value="${webSocketResource.uri}"/></td>
        </tr>
    </table>
