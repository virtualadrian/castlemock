...
<div class="content-top">
    <h1><spring:message code="websocket.event.header.log" arguments="${event.id}"/></h1>
</div>

<div class="content-summary">
    <table class="formTable">
        <tr>
            <td class="column1"><label path="name"><spring:message code="websocket.event.column.id"/></label></td>
            <td class="column2"><label path="name">${event.id}</label></td>
        </tr>
        <tr>
            <td class="column1"><label path="name"><spring:message code="websocket.event.column.startdate"/></label></td>
            <td class="column2"><label path="name">${event.startDate}</label></td>
        </tr>
        <tr>
            <td class="column1"><label path="name"><spring:message code="websocket.event.column.enddate"/></label></td>
            <td class="column2"><label path="name">${event.endDate}</label></td>
        </tr>
        <tr>
            <td class="column1"><label path="name"><spring:message code="websocket.event.column.request.uri"/></label></td>
            <td class="column2"><label path="name">${event.request.uri}</label></td>
        </tr>
        <tr>
            <td class="column1"><label path="name"><spring:message code="websocket.event.column.request.methodtype"/></label></td>
...
<div>
    <h2 class="decorated"><span><spring:message code="websocket.event.header.request"/></span></h2>
    <h3><span><spring:message code="websocket.event.header.body"/></span></h3>
...
<div>
    <h2 class="decorated"><span><spring:message code="websocket.event.header.response"/></span></h2>
    <table class="formTable">
        <tr>
            <td class="column1"><label path="name"><spring:message code="websocket.event.column.response.statuscode"/></label></td>
